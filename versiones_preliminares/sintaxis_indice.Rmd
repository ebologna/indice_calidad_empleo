...
# Desocupación  
## solo actives: desocupades/total  
```{r}
...
# Proporción de cuentapropistas  
## solo ocupades (CAT_OCUP==2)/total  
...
# Seguridad  
## solo asalariades: permanencia + obra social + aguinaldo + vacaciones + dias por enfermedad + descuento jubilatorio
...
# Ingresos  
## solo ocupades sin ceros, perdidos y 1% superior    
...
# Ingresos - hora  
## solo ocupades: horas semanales por cuatro  
```{r}
